...
const Header = () => {
  return (
    <header className='flex justify-between items-center flex-row px-2 sm:px-20 md:px-40 pt-2 sm:pt-6 bg-transparent backdrop-blur-md fixed w-full'>
      ...
      <ul className='text-[13px] md:text-sm lg:text-sm text-sky-200 sm:font-semibold flex md:gap-6 sm:gap-4 gap-2'>
        ...
        <NavLink to='#blog' className='hover:text-slate-200 transform sm:hover:scale-105'>Blog</NavLink>
        <NavLink to='#contactUs' className='hover:text-slate-200 transform sm:hover:scale-105'>About Us</NavLink>
