...
const MissionVision = ({title, content}) => {
  return (
    <div className="relative">
        ...
        <div className="bg-transparent backdrop-blur-sm shadow-md hover:scale-105 shadow-sky-800 p-2 sm:p-4 rounded-md md:rounded-lg mt-3 sm:mt-4 min-h-fit md:min-h-40">
